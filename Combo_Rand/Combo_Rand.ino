...
//double Kp = 1.65, Ki = 0.0278, Kd = 49.2;    //Testing of Tuning algo
//double Kp = 17., Ki = 0., Kd = 0.01;    //Testing of Tuning algo - Step 4
//double Kp = 11.1, Ki = 0.093, Kd = 0;    //BEST SO FAR (14/3/22)
double Kp = 15.1, Ki = 0.293, Kd = 0.07;    //BEST SO FAR (14/3/22)
...
void setup() {
  ...
  myPID.SetOutputLimits(-150, 250); //having -ve output allows system to reverse output when overshot instead of just turning off
  ...
  //  pid_set = 520; // this analogue value roughly represents vertical pot position
  ...
  Serial.print("SET_PERC:,SETPOINT:");
  Serial.println();
...
void loop() {
  ...
  //  Serial.println("SETPOINT:,CURRENT_POSITION:,OUPUT:");
